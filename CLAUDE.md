# CLAUDE.md — Global Architectural Rules

Single source of truth for rules that apply **everywhere** in this monorepo.
Each subdirectory has its own `CLAUDE.md` — read both.

> Sub-guides:
> - [`frontend/web/CLAUDE.md`](frontend/web/CLAUDE.md) — Next.js web app
> - [`frontend/mobile/CLAUDE.md`](frontend/mobile/CLAUDE.md) — Ionic mobile app
> - [`frontend/_common/CLAUDE.md`](frontend/_common/CLAUDE.md) — Shared hooks, services, stores, ui-kit
> - [`backend/CLAUDE.md`](backend/CLAUDE.md) — NestJS API + migrations
