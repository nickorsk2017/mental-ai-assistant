...
interface PatientPlaceholderWorkspaceProps {
  sectionHeading: string;
  sectionDescription: string;
}

const PatientPlaceholderWorkspace = React.memo(function PatientPlaceholderWorkspace({
  sectionHeading,
  sectionDescription,
}: PatientPlaceholderWorkspaceProps) {
  return (
...
export default PatientPlaceholderWorkspace;
