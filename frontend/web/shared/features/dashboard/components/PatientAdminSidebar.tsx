...
const PatientAdminSidebar = React.memo(function PatientAdminSidebar({
  ...
  return (
    <aside className="flex h-[calc(100vh-2rem)] w-[272px] shrink-0 flex-col rounded-[28px] border border-calm-border/60 bg-calm-surface/50 px-4 py-6 shadow-subtle backdrop-blur-xl">
          ...
          return (
            <Link
              ...
              className={`rounded-2xl px-3 py-3 text-sm font-semibold transition ${
                isActive
                  ? 'bg-calm-second/15 text-calm-text shadow-subtle'
                  : 'text-calm-muted hover:bg-calm-background hover:text-calm-text'
              }`}
            >
      ...
      <div className="mt-auto rounded-2xl border border-calm-border/40 bg-calm-background/60 px-3 py-3">
