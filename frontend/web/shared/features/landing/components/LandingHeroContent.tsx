  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="mt-8 flex flex-col gap-3 sm:flex-row">
        <Link
          href="/auth"
          className="inline-flex items-center justify-center rounded-full border border-calm-black bg-calm-black px-6 py-4 text-base font-semibold text-calm-primary-text shadow-medium transition hover:-translate-y-0.5 hover:brightness-95"
        >
          Try for free
        </Link>
      </div>
