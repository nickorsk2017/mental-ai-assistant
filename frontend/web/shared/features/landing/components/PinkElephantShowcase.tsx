...
const PinkElephantShowcase = React.memo(function PinkElephantShowcase() {
  return (
    <div className="relative mx-auto hidden w-full max-w-[1280px] lg:block lg:justify-self-end">
      ...
      <div className="absolute right-0 top-1/2 h-[430px] w-[430px] -translate-y-1/2 rounded-full border-[10px] border-calm-second/10" />
      <div className="absolute right-6 top-1/2 h-[390px] w-[390px] -translate-y-1/2 rounded-full border-[8px] border-calm-second/8" />
      <div className="absolute right-12 top-1/2 h-[350px] w-[350px] -translate-y-1/2 rounded-full border-[6px] border-calm-second/6" />
      ...
      <div className="relative aspect-[1.02/1]">
        ...
        <div className="absolute left-[17%] top-[39%] flex h-16 w-16 items-center justify-center rounded-full border-2 border-calm-second/22 bg-white/38 shadow-subtle backdrop-blur-sm">
